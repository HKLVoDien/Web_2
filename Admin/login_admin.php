					...
					<div class="col-lg-12 login-form">
						<form action="" method="post" autocomplete="off">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="un" onkeyup="daoNutDN()" id="un" autofocus autocomplete="off">
							</div>
							<div class="form-group">
							...
							<div class="col-lg-12 loginbttm">
								...
								<div class="col-lg-12 login-btm login-button text-center">
									<button type="submit" class="btn btn-outline-primary" id="btndangnhap" name="btndangnhap" onclick="return validate()">Đăng
										nhập</button>
								</div>
							</div>
						</form>
